...
namespace WebAPI.Controllers
{
    ...
    public class PaymentDetailController : ControllerBase
    {
        ...
        public PaymentDetailController(PaymentDetailContext context, IOptions<ApplicationSettings> appSettings)
        {
            _context = context;
        ...
        public async Task<IActionResult> PostPaymentDetail([FromBody] PaymentDetail paymentDetail)
        {
            ...
            /*
            var userIdentity = _mapper.Map(paymentDetail);

            var result = await _userManager.CreateAsync(userIdentity, paymentDetail.CVV);
